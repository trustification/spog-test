...
def file_is_loaded(page:Page,type:str):
    page.locator("h1").get_by_text(f"Get started by uploading your {type} file").is_hidden()
    load_button = page.locator("button").get_by_text(f"Load an {type}").is_hidden()

def file_is_not_loaded(page:Page,type:str):
    page.locator("h1").get_by_text(f"Get started by uploading your {type} file").is_visible()
    load_button = page.locator("button").get_by_text(f"Load an {type}")
